...
- add env that allowing write log to file ([13f17e2](https://github.com/K4zoku/FF-WebHID/commit/13f17e20216a9e750641dead0d3b8b9d32b9e95c))
- bypass sec-fetch-dest gated on server ([d96eab8](https://github.com/K4zoku/FF-WebHID/commit/d96eab88f7ed6a340430f3a50c5b7e8fcfb49989))
- collections prune ([2fb614a](https://github.com/K4zoku/FF-WebHID/commit/2fb614a7bc47244a742cf55a6619dd36df705e14))
- CSP pre-flight detection to skip doomed shadow worker spawn ([b610751](https://github.com/K4zoku/FF-WebHID/commit/b6107511b030e27d5a6a76a2c1cf1e813aab00e1))
- daemon now print warnings when running as root ([13127fd](https://github.com/K4zoku/FF-WebHID/commit/13127fd1d20f27fb63b92681c50143d733c3e663))
- data worker batch handler ([c609413](https://github.com/K4zoku/FF-WebHID/commit/c609413c916c5158e7aea2f774991ab52d59bb23))
- default hardening is off ([4e85ff8](https://github.com/K4zoku/FF-WebHID/commit/4e85ff8ccea6de7069b66e1cdcde85fdc6b07525))
- default report level blocking is off ([50b3391](https://github.com/K4zoku/FF-WebHID/commit/50b3391472f689069bb5658d9363f3f3cabbbc1c))
- default workerSpawnMode to blob on MV2 ([f8d7018](https://github.com/K4zoku/FF-WebHID/commit/f8d701867f77e3002dc5d57996d400ac9d215f32))
- fail fast to NM when header CSP blocks workers on MV3 ([b6529c2](https://github.com/K4zoku/FF-WebHID/commit/b6529c2c51ff28c1ecf1253db67f8389888418eb))
- handle shadow-url edge cases ([e88623b](https://github.com/K4zoku/FF-WebHID/commit/e88623b722c96e2fc6230e071326490ccedd44ed))
- i18n + a11y for picker, popup, settings ([13b6104](https://github.com/K4zoku/FF-WebHID/commit/13b610477a7e53f6cbf28dfcd4c5e51eeaf8934d))
- in-page WT ([e1f3729](https://github.com/K4zoku/FF-WebHID/commit/e1f37293592422602d077b5f2c3f5467e4f986a2))
- isSecureContext check & allow requestDevice in console ([8729d26](https://github.com/K4zoku/FF-WebHID/commit/8729d26105917664692f8fbb92836472ed00d524))
- migrate storage to IndexedDB + per-key settings ([2b151ae](https://github.com/K4zoku/FF-WebHID/commit/2b151ae659d46078d20929b4db74579751ba1ff0))
- move root daemon to abstract socket ([01c1b2e](https://github.com/K4zoku/FF-WebHID/commit/01c1b2e5215f760f1dea31ba6fbfa79984e9f7bd))
- mv2 support ([52c07bc](https://github.com/K4zoku/FF-WebHID/commit/52c07bc6e4220b35b8560d0e350e04273678b9e2))
- mv2 support (firefox 58+) ([0297ea5](https://github.com/K4zoku/FF-WebHID/commit/0297ea5b462b7a4c2b0688832986d6f5a8d5b656))
- permission policy ([d3cbec6](https://github.com/K4zoku/FF-WebHID/commit/d3cbec689ca1b25fb58dc4560457b7c50ec598a1))
- report check when write ([1fe1678](https://github.com/K4zoku/FF-WebHID/commit/1fe1678a680b35fd08fd2c4c65cec9d191b88429))
- report-level blocking ([8de34a6](https://github.com/K4zoku/FF-WebHID/commit/8de34a65277b5c542fae8d3bfbaaf20a35b44add))
- rewrite meta-tag CSP via StreamFilter, cache TT policy ([3b70028](https://github.com/K4zoku/FF-WebHID/commit/3b7002871ef0da4e657cf886558eaaad86dd2299))
- rich text i18n support ([811f1e1](https://github.com/K4zoku/FF-WebHID/commit/811f1e13da1acbab48ac50b8bdeb662c2e361e3a))
- sec-fetch-dest check ([99bf49d](https://github.com/K4zoku/FF-WebHID/commit/99bf49d67001c74e2f52a82c20f52827205da4ee))
- security hardening ([a434282](https://github.com/K4zoku/FF-WebHID/commit/a434282142ac7b4afb1b69c44536438f1a05c76e))
- theme sync ([6f221c0](https://github.com/K4zoku/FF-WebHID/commit/6f221c03ecf7271ade0712213993e3bb4a99bb7c))
- TLV binary packing for DeviceInfo.collections ([128f40a](https://github.com/K4zoku/FF-WebHID/commit/128f40aa4e8bf4f7b05e30a4ce3200dcf9d70637))
- trusted type now working properly ([03e9488](https://github.com/K4zoku/FF-WebHID/commit/03e948805b05af9ac39f9c49469722288f85288b))
- WebTransport ([9c4ff18](https://github.com/K4zoku/FF-WebHID/commit/9c4ff186bbcfb7c7a700076897c90f2fd1d0476a))
- worker polyfill impl ([21faed1](https://github.com/K4zoku/FF-WebHID/commit/21faed1d6f5473a5667f7a13cb15b8a6e98f6123))
- worker polyfill stub ([c74f1bd](https://github.com/K4zoku/FF-WebHID/commit/c74f1bd412439a185bb33503bad89e5853aafc47))
- worker spawn fallback mode (blob + CSP rewrite) ([404c429](https://github.com/K4zoku/FF-WebHID/commit/404c42913062cb28cfe24efa0f0c6456744a04e5))
- wt in-page now fully handle hotpath ([83cd2d0](https://github.com/K4zoku/FF-WebHID/commit/83cd2d08f926bbc281ed94273db47a4844c33f83))
- WT without worker ([3a36c92](https://github.com/K4zoku/FF-WebHID/commit/3a36c92121ee8c884ad90f6073fe59698104f5c7))

### Bug Fixes

- 8 spec compliance fixes across daemon and polyfill ([a8a64c2](https://github.com/K4zoku/FF-WebHID/commit/a8a64c2c4e481d16ec1527b1d792a5ebb2aebb60))
- add back gate for unix ([0d5f156](https://github.com/K4zoku/FF-WebHID/commit/0d5f1561a782e3d37e4906b0b3445c0e1f0083c3))
- better use strict handler ([283c34c](https://github.com/K4zoku/FF-WebHID/commit/283c34c22bbc1a246003b13e6a0c7cef9b26ebe9))
- clippy lint ([ecbb3d6](https://github.com/K4zoku/FF-WebHID/commit/ecbb3d6851902e95535858ac5c9affbfe27a3185))
- constant-time WS auth compare ([0aec2fb](https://github.com/K4zoku/FF-WebHID/commit/0aec2fb673d9a8dcc71ffd6a998eb4f23257296b))
- cross platform build errors ([5278bd7](https://github.com/K4zoku/FF-WebHID/commit/5278bd7aeb93b3567b561297f0f898182155f2dd))
- CSP rewrite for blob mode + test fixes ([a198736](https://github.com/K4zoku/FF-WebHID/commit/a19873611f1b8bdc5f54a7db149d4721b492b033))
- current benchmark not parity with docs (partial fix) ([341fcc2](https://github.com/K4zoku/FF-WebHID/commit/341fcc2297a20116dd80491136e95ce495f45f8b))
- data worker ack on init message ([e2c4978](https://github.com/K4zoku/FF-WebHID/commit/e2c49787d9fedd791ff25a9adeec98e99d1bcd94))
- dataplane_mode per session instead of per device ([17d86b7](https://github.com/K4zoku/FF-WebHID/commit/17d86b7c9ef0a74f212f8acde3401306372af4cf))
- event double fire ([36e5ced](https://github.com/K4zoku/FF-WebHID/commit/36e5cede00a311a1c260a19b8a4b8e1eb844b4c8))
- js/ts lint ([c5c5f92](https://github.com/K4zoku/FF-WebHID/commit/c5c5f92ed28c037204b5547e33b5dcc3dc580312))
- logger env ([8b4c447](https://github.com/K4zoku/FF-WebHID/commit/8b4c4473a49ce72428b0267e421fa611c9358742))
- now the worker performance match benchmark.md ([0d90e4b](https://github.com/K4zoku/FF-WebHID/commit/0d90e4b5fc2628b8cada69b8ac27ed1dc18585f4))
- origin check for sandbox iframe ([7983ed4](https://github.com/K4zoku/FF-WebHID/commit/7983ed425ca71d9c8b913efd4d71f98a40f3ea74))
- page xss vulnerability (tt factory exposed) ([995faaf](https://github.com/K4zoku/FF-WebHID/commit/995faafdaf472714ada8746117a9213252f71c2b))
- report level block list now work properly ([792751a](https://github.com/K4zoku/FF-WebHID/commit/792751ab354c92338f051d91265f494e497390ca))
- report level blocking now match 1:1 with chromium source ([c6607d4](https://github.com/K4zoku/FF-WebHID/commit/c6607d43127ddc94c8cb67b905804ab726edac81))
- requestDevice cancel now return empty array instead of throwing ([5e6a47e](https://github.com/K4zoku/FF-WebHID/commit/5e6a47edaa812b4846d15d881ef959c25ca82339))
- resolve all addons-linter warnings ([0bbc4ed](https://github.com/K4zoku/FF-WebHID/commit/0bbc4edd181b6d0d26b6e5455185e6fdbe4f113f))
- review fixes for worker spawn fallback ([4ed0a10](https://github.com/K4zoku/FF-WebHID/commit/4ed0a10c01edc2d2d7f694c29be7a6f310d5a667))
- rust code smell ([aa92690](https://github.com/K4zoku/FF-WebHID/commit/aa926902bb3aafbafcd794a62bd4c931303519fb))
- settings behavior ([dddd587](https://github.com/K4zoku/FF-WebHID/commit/dddd587753a60d5069d0229e18fd29dfee91d742))
- shadowdom picker consent bypass ([a2fe259](https://github.com/K4zoku/FF-WebHID/commit/a2fe259ee4fb16fbf0adcc9dcc96ec36cd031a80))
- some bugs ([d42bce3](https://github.com/K4zoku/FF-WebHID/commit/d42bce3e68c6d5f4a759280e90cd16eb432fadeb))
- some more security hardening ([274aec8](https://github.com/K4zoku/FF-WebHID/commit/274aec833e7ddd7608c223d09b79d1855ea5d09f))
- strict_min_version lint ([c7e83c3](https://github.com/K4zoku/FF-WebHID/commit/c7e83c3e2967caaaeb9ce14c4ea2c0c53996a78c))
- sync MV2 manifest and injector script lists with MV3 ([04c3a1e](https://github.com/K4zoku/FF-WebHID/commit/04c3a1e2f75becbf0f05a157f0fa06bfc9634080))
- throw on success ([6e9cccd](https://github.com/K4zoku/FF-WebHID/commit/6e9cccd34dd917884637401092153ae0c6363ab1))
- warning in wrong branch ([6d5ed22](https://github.com/K4zoku/FF-WebHID/commit/6d5ed22614dc394c19480a26ca6ff93504c57123))
- windows build error ([cf2e1cc](https://github.com/K4zoku/FF-WebHID/commit/cf2e1cc73500f5b9dbb6e1884c440613c1188f23))
- wire protocol drift ([4b1ba28](https://github.com/K4zoku/FF-WebHID/commit/4b1ba281104f8aa1a6407893bd04589febd8e7d4))
- wrong path ([5812e0e](https://github.com/K4zoku/FF-WebHID/commit/5812e0ec7890c1ff8a75e8f3eaaf8187e504d352))

### Performance

- rate-gated ws batching eliminates render-load report loss ([7e41d07](https://github.com/K4zoku/FF-WebHID/commit/7e41d072595d28e9376411c9ea2c5872218b1799))
- using persistence bidirectional stream for WT ([604c769](https://github.com/K4zoku/FF-WebHID/commit/604c769c815df97b1e06068c23ae7f0dc41b0794))

### Code Refactoring

- add jsdoc ([1b176b4](https://github.com/K4zoku/FF-WebHID/commit/1b176b4d676d9031bea3fd98ba02e6310ce95169))
- centralize runtime bundle file lists in js/bundle-files.js ([073b9d3](https://github.com/K4zoku/FF-WebHID/commit/073b9d33692be1c7a285fba80c379fa0f9553906))
- cleanup ([2d488af](https://github.com/K4zoku/FF-WebHID/commit/2d488afc244eacaeb62a066bddc617a33397f1f0))
- cleanup ([4b0ca30](https://github.com/K4zoku/FF-WebHID/commit/4b0ca304d13001e0d0209620b57756beb105d805))
- cleanup dead code ([f4e5dbd](https://github.com/K4zoku/FF-WebHID/commit/f4e5dbdc073b7d15e938c4f3d3ab712d14c079b3))
- cleanup, add debug log ([093f4df](https://github.com/K4zoku/FF-WebHID/commit/093f4df2ba9293de698a680c414b627d0f2712a7))
- code smell ([0eebdb3](https://github.com/K4zoku/FF-WebHID/commit/0eebdb35343865c2deccb67585de5cfa50f1d2bd))
- colocate page HTML+CSS+JS into internal/pages/ ([53280c5](https://github.com/K4zoku/FF-WebHID/commit/53280c58524854f70f51e966bde6c2a6cea204e8))
- move bridge, picker, worker, inject to content/isolated/ ([fc7e4ca](https://github.com/K4zoku/FF-WebHID/commit/fc7e4caf508fb4d9ade528236493c6eb9b5baa84))
- move bundle-files.js under js/utils/ ([c24cd75](https://github.com/K4zoku/FF-WebHID/commit/c24cd751000f571f8c8f60de929d8488a39c48c4))
- move polyfill.js to content/main/index.js ([f6e06b0](https://github.com/K4zoku/FF-WebHID/commit/f6e06b0a5913648b69c41dd056c4da58e41e78d0))
- move report blocking into separated module ([7ca80b4](https://github.com/K4zoku/FF-WebHID/commit/7ca80b41811d4dfcdb6d6ec6b5fcfe2f4dbdd9fa))
- remove redundant message data ([17e3829](https://github.com/K4zoku/FF-WebHID/commit/17e3829ce135caab628b5af8f26b89df59582164))
- rename bundle-files keys to clarify MV2 usage ([4532f02](https://github.com/K4zoku/FF-WebHID/commit/4532f02c8719cb3755a25fba754cad05ec316d81))
- reorder declaration ([5088cdc](https://github.com/K4zoku/FF-WebHID/commit/5088cdc1b6defa4cf34c0781e043e94f2a61b64f))
- split background.js into background/ folder ([888d159](https://github.com/K4zoku/FF-WebHID/commit/888d1590a4c7617b4a74374c89c473876c3fcf38))
- update manifest paths for new file structure ([0415fdd](https://github.com/K4zoku/FF-WebHID/commit/0415fddcb0e8e16687780d81849506e6f85bd9b3))

### Documentation

- add JSDoc type annotations to all 19 addon JS files ([ab0e510](https://github.com/K4zoku/FF-WebHID/commit/ab0e510389e093913f00059cc3383eaa978ae172))
- add spec evaluation docs ([4876ae4](https://github.com/K4zoku/FF-WebHID/commit/4876ae494b3765434bdc5527d70b4a0d12898a5a))
- mermaid sequence diagrams for all data paths ([4e22e94](https://github.com/K4zoku/FF-WebHID/commit/4e22e947f5d1520523f4b1c3806807241ea8954c))
- record MV3 strengthen-only CSP platform constraint ([e792efa](https://github.com/K4zoku/FF-WebHID/commit/e792efa48873a44776a110c565211a198a1ab3d0))
- restructure, add table to benchmark.md ([6490688](https://github.com/K4zoku/FF-WebHID/commit/64906887e8a560719fb8a18989814027852facec))
- sync docs with code ([43fef7b](https://github.com/K4zoku/FF-WebHID/commit/43fef7be62a9768456e8d2d6a3191907c234f23b))
- update benchmark note ([3b5b114](https://github.com/K4zoku/FF-WebHID/commit/3b5b114751cf9783d035ce277cd3c7a433be9117))
- update docs ([116e20e](https://github.com/K4zoku/FF-WebHID/commit/116e20eb48e15dd8010ac89190cce66a66b910a0))
- update docs ([68a539e](https://github.com/K4zoku/FF-WebHID/commit/68a539ed4ab356003f26716bad43d1adc4f8d142))
- update docs ([49ad7cb](https://github.com/K4zoku/FF-WebHID/commit/49ad7cb58b6aadf495afbc7ae3660e6679b70eb3))
- update info about report-blocking gate ([c0a7663](https://github.com/K4zoku/FF-WebHID/commit/c0a76630892ab32bb8c0e7bf93cd9689b29a6472))
- update INSTALLATION ([364af7c](https://github.com/K4zoku/FF-WebHID/commit/364af7cc2240368b3d01c575b10204747c7bce07))
- update note for blocking spec ([882a364](https://github.com/K4zoku/FF-WebHID/commit/882a3645272fa887359ece9b5b6b25b8c68b1f43))
- update principles ([9a39292](https://github.com/K4zoku/FF-WebHID/commit/9a392928c5237532d0a856c01f90c5b90b9f2a00))
- update README ([9a15c07](https://github.com/K4zoku/FF-WebHID/commit/9a15c0743f92d1e39feccb340ea84989d036bf60))
- update stale info, add new info, reformat all ([d279a84](https://github.com/K4zoku/FF-WebHID/commit/d279a84fc880654d13358ef28034e4f87b358b2a))
- ws batching and render-load loss design records ([01c99d3](https://github.com/K4zoku/FF-WebHID/commit/01c99d383f94e1622eee9fd2d993b2af276ea0f4))

### CI/CD

- add apt cache ([ddf140b](https://github.com/K4zoku/FF-WebHID/commit/ddf140b8c2e8d913e9c3b3688e94535417c4890b))
- add back upload to AMO ([446ff45](https://github.com/K4zoku/FF-WebHID/commit/446ff45e5c8f0cdddc07d9311e73a759e012cc2f))
- add benchmark to test flow ([e7211e7](https://github.com/K4zoku/FF-WebHID/commit/e7211e7809ba5563794e772beeb19f19d0a8831f))
- add permission ([08ac874](https://github.com/K4zoku/FF-WebHID/commit/08ac8741a39d21e559f2c8f59addf9a9e68b6260))
- add playwright install back ([a79d15d](https://github.com/K4zoku/FF-WebHID/commit/a79d15d93272136e54d4ea82156f295717157035))
- add v prefix for version ([c337d33](https://github.com/K4zoku/FF-WebHID/commit/c337d33ca3e75a722641c5ab1280fe7e47e3943b))
- browser only spec test, warning on npm check fail (fine for dev ([e522592](https://github.com/K4zoku/FF-WebHID/commit/e52259223d161696c306349a26b84e5a26c5d0b0))
- build webhid-mock ([4b79a31](https://github.com/K4zoku/FF-WebHID/commit/4b79a31d52290ccfa6d898b9f36c429515fbd77b))
- fix artifact name ([75fd533](https://github.com/K4zoku/FF-WebHID/commit/75fd53384c95e2dbad86d88b89a75d55c4bc0fe0))
- fix build msi ([208993c](https://github.com/K4zoku/FF-WebHID/commit/208993c1bf9d8707b327fd059b42eec8a0e9b3b0))
- fix missing wix ext ([2e7a043](https://github.com/K4zoku/FF-WebHID/commit/2e7a043e12d513a5e176703822c99093b9aa780a))
- fix typo ([e209ef5](https://github.com/K4zoku/FF-WebHID/commit/e209ef58e3ebe72de5f67bd4246998abeb130129))
- fix wrong artifact name ([d51f4a5](https://github.com/K4zoku/FF-WebHID/commit/d51f4a553636c6af4a51afa162f2fb08efae02c6))
- normalize name, fix release flow ([2b91e4a](https://github.com/K4zoku/FF-WebHID/commit/2b91e4a64840846595f9f001929367fdebfa1826))
- pin action version ([8cc6f48](https://github.com/K4zoku/FF-WebHID/commit/8cc6f4806f105576c6a0597d6e06c81aff78a5db))
- pin to ubuntu-24.04 ([bebcc4e](https://github.com/K4zoku/FF-WebHID/commit/bebcc4e2857cd5060a1b0422509aff5b358a87a2))
- test build rs ([10b6019](https://github.com/K4zoku/FF-WebHID/commit/10b601915cfeac973cf5d90ed5d1c06503535573))
- update build flow ([62b6c84](https://github.com/K4zoku/FF-WebHID/commit/62b6c84d01204dec8a4e9082cb8acf36f6b209ba))
- update repo ([5a8ad0a](https://github.com/K4zoku/FF-WebHID/commit/5a8ad0a5faa353452ba76c84c459f619ce45f7b7))
- update tests, switch back to npm ([fb6230f](https://github.com/K4zoku/FF-WebHID/commit/fb6230f978a9fa81fae6e2266f8eeb82fdf5a598))
- using nub for everything ([2de15af](https://github.com/K4zoku/FF-WebHID/commit/2de15affd79d2df745863b09013dec31a7bf8516))

### Chores

- add ISC to cargo deny config ([fee3150](https://github.com/K4zoku/FF-WebHID/commit/fee3150f5e50b7a263f929f18dfeb0c3fe20be74))
- add Prettier config ([0c3902d](https://github.com/K4zoku/FF-WebHID/commit/0c3902dc50eb06b0864d9324297f6b564ca5d67b))
- add root tsconfig and type declarations ([1496441](https://github.com/K4zoku/FF-WebHID/commit/14964417b6fce69dfa06101bd877500b2d650d91))
- bump addons-linter pkg, fix some audit ([808805d](https://github.com/K4zoku/FF-WebHID/commit/808805d5796d02698403ff0119f69ec440a235c6))
- fix audit ([0ce257b](https://github.com/K4zoku/FF-WebHID/commit/0ce257bac72f95a42c9281851c2b42bd10b60d14))
- fix cargo.lock version script ([e6aa3f5](https://github.com/K4zoku/FF-WebHID/commit/e6aa3f547a4b75d0f975915ae1c9da74038b1679))
- remove npm pinning ([eb2c920](https://github.com/K4zoku/FF-WebHID/commit/eb2c92035d19de28c4b6cd662a834878d4854736))
- switch back to npm, pin deps ([730d2da](https://github.com/K4zoku/FF-WebHID/commit/730d2da518fe6962135f20ee515b35d8f1c9219f))
- update i18n ([ab77c2e](https://github.com/K4zoku/FF-WebHID/commit/ab77c2e66aef490ff5db7e3593a906ce8f86f082))
- update template ([4d1f933](https://github.com/K4zoku/FF-WebHID/commit/4d1f933e23c4b02d63245f59b657b19a729e843f))

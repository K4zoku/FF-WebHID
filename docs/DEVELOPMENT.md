...
│   ├── fixtures/descriptors/ Binary HID report descriptors (generated by scripts/gen-descriptors.py)
│   ├── types/               TS type stubs
...
├── scripts/
│   └── gen-descriptors.py   Generates sample HID report descriptors for uhid-mock tests

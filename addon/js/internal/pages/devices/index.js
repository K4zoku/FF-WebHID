;(async () => {
  ...
  async function render() {
    ...
    for (const { origin, devices } of origins) {
      ...
      // Group by product name like the picker so multi-interface devices show
      // as one card; forgetting the card revokes every member (the background
      // unions recorded grant groups across them).
